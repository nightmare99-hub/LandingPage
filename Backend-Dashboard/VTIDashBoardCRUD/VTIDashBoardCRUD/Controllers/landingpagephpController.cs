...
{
    public class landingpagephpController : ApiController
    {
        ...
        public string Post(landingpagephp ldp)
        {
            try
            {
                string query = @"
                    insert into dbo.LandingPagePhp values
 ...
 ,'" + ldp.landingpage_email + @"'
        ...
        public string Put(landingpagephp ldp)
        {
            try
            {
                string query = @"
                    update dbo.LandingPagePhp set 
 ...
 ,landingpage_email='" + ldp.landingpage_email + @"'
        ...
        public string Delete(int id)
        {
            ...
            {
                string query = @"
                    delete from dbo.LandingPagePhp 
