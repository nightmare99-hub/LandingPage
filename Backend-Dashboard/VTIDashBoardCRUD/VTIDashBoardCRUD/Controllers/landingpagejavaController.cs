...
{
    public class landingpagejavaController : ApiController
    {
        ...
        public string Post(landingpagejava ldp)
        {
            try
            {
                string query = @"
                    insert into dbo.LandingPageJava values
...
,'" + ldp.landingpage_email + @"'
        ...
        public string Put(landingpagejava ldp)
        {
            try
            {
                string query = @"
                    update dbo.LandingPageJava set 
 ...
 ,landingpage_email='" + ldp.landingpage_email + @"'
        ...
        public string Delete(int id)
        {
            ...
            {
                string query = @"
                    delete from dbo.LandingPageJava 
